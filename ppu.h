...
typedef int (*ppu_read_func_t) (int address); // read data [8bit] from address [16bit]
typedef void (*ppu_write_func_t) (int address, int value); // write data [8bit] to address [16bit]
typedef void (*ppu_update_frame_func_t) (uint8_t* frame_data, int width, int height);
